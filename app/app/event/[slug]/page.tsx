      ...
      <div className="grid gap-6 lg:grid-cols-[1.2fr_0.8fr]">
        <Card className="flex flex-col gap-4">
          ...
          <div className="rounded-xl border border-border bg-surface p-4">
            <p className="text-xs uppercase tracking-wide text-muted">Expected move (preview)</p>
          ...
          <div>
            <p className="text-xs uppercase tracking-wide text-muted">Triggers</p>
        ...
        <Card className="flex flex-col gap-4">
          <p className="text-xs uppercase tracking-wide text-muted">Unlock pack</p>
          <h3 className="text-xl font-semibold">$10 Event Expectations Pack</h3>
          <p className="text-sm text-muted">
